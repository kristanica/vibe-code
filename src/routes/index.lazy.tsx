...
import { Play, Info, X, HelpCircle, Zap, Swords, Shield, Dice5 } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-slate-950 text-slate-50 overflow-hidden relative">
      ...
      <div className="text-center mb-12 relative z-10">
        ...
        >
          Manipulate the odds, build your deck, and escape the collapsing casino.
        </motion.p>
      </div>
      ...
      <div className="grid gap-4 w-full max-w-xs relative z-10">
        ...
        >
          <span className="font-black text-xl uppercase italic tracking-tighter">Start Run</span>
        ...
        >
          <span className="font-black uppercase italic tracking-tighter text-slate-300 group-hover:text-white">How to Play</span>
        ...
        <button className="group flex items-center justify-between p-5 bg-slate-900/50 opacity-50 cursor-not-allowed rounded-2xl border border-slate-800">
          <span className="font-black uppercase italic tracking-tighter text-slate-500">Collection</span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex justify-between items-center mb-8 relative z-10">
                <h2 className="text-3xl font-black uppercase italic tracking-tighter text-indigo-400">Rules of the House</h2>
                <button 
                  onClick={() => setShowTutorial(false)}
              ...
              <div className="space-y-6 relative z-10">
                <section className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-black uppercase text-xs text-indigo-300 mb-1 tracking-widest">Energy & Actions</h3>
                    <p className="text-sm text-slate-400 leading-relaxed">Each turn you start with 3 energy. Every card has an energy cost displayed in its top-right corner.</p>
                  </div>
                </section>
                ...
                <section className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-black uppercase text-xs text-emerald-300 mb-1 tracking-widest">The Odds</h3>
                    <p className="text-sm text-slate-400 leading-relaxed">Unlike other games, every action has a success rate. High-reward cards are riskier. Hover over a card to <span className="text-indigo-400 font-bold">FLIP</span> it and see the fine print.</p>
                  </div>
                </section>
                ...
                <section className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-black uppercase text-xs text-red-300 mb-1 tracking-widest">Combat & Victory</h3>
                    <p className="text-sm text-slate-400 leading-relaxed">Reduce the enemy's HP to zero to progress. If your HP hits zero, your run ends immediately.</p>
                  </div>
                </section>
                ...
                <section className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-black uppercase text-xs text-purple-300 mb-1 tracking-widest">Drafting</h3>
                    <p className="text-sm text-slate-400 leading-relaxed">After every victory, you'll choose one new card to add to your deck. Choose wisely to build your winning strategy.</p>
                  </div>
                </section>
              </div>
